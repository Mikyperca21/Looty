			...
			<div class = "content">
				...
				<div class = "text">
					...
					<form action = "catalogo" method = "post">
						<input name = "quantita" type = "number" value = "1" max = "<%= prodotto.getQuantita() %>" placeholder = "Quantit&agrave;"> <!-- dinamico in base alla quantità nel db;  &agrave per la à;-->
						<!-- input nascosto con l'id -->
						<br>
						<br>
